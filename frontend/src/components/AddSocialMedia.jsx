...
const AddSocialMedia = (props) => {
  ...
  const [igRequired, setIgRequired] = useState(false)
  const [twRequired, setTwRequired] = useState(false)
    ...
    <div>
        <div className='mt-5 p-4 bg-white shadow-lg rounded-md'>
            ...
            <div className='flex gap-3'>
              ...
              {props.media === 'facebook' ?
                <div className='mt-2.5 text-red-600 font-medium'>{fbRequired ? 'required !' : ''}</div>
                :
                (props.media === 'twitter' ?
                    <div className='mt-2.5 text-red-600 font-medium'>{twRequired ? 'required !' : ''}</div>
                :
                    <div className='mt-2.5 text-red-600 font-medium'>{igRequired ? 'required !' : ''}</div>
                )
              }
            </div>
          </div>
